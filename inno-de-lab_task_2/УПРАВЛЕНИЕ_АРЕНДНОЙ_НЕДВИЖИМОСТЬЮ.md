...
- **Constraints:**
  ...
  - **CHK_TenantAge:** CHECK (DateOfBirthday >= DATE'1900-01-01')
...
- **Constraints:**
  ...
  - **CHK_ContractDate** CHECK (ContractEndDay > ContractStartDay)
...
- **Constraints:**
  ...
  - **UQ_RequestEmployee** UNIQUE (RequestId, EmployeeId)
...
CREATE TABLE Contracts (
    ...
    CONSTRAINT CHK_ContractDate CHECK (ContractEndDay > ContractStartDay)
);
...
CREATE TABLE "Request Assignments" (
    ...
    CONSTRAINT UQ_RequestEmployee UNIQUE (RequestId, EmployeeId)
);
```
